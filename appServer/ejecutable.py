...
# # index.html
# # Copyright (C) 2019 Daniela Rojas Lozano, ddp.rojas11@uniandes.edu.co
# # Configuración, atributos, diseño de interfaz.
# # main.py 
# # Copyright (C) 2023 Vilma Marcela Tirado Gómez, vm.tirado@uniandes.edu.co
# # Actualización de librerias, actualización de interfaz, compatibilidad con sistemas embebidos
# # Asesor 
...
def actualizar_estado():
	...
	global NUMERO_MAXIMO_MODULOS
	for modulo in  range(0,NUMERO_MAXIMO_MODULOS): 
		ACTIVIDAD_ACTUAL[modulo] = int(request.form['estadoPersona'+str(modulo)])
	#print('ACTIVIDAD_ACTUAL',ACTIVIDAD_ACTUAL)
